...
public class CommonResult <T>{
     ...
     * 成功返回结果
     */
    public static <T> CommonResult<T> success (ResultCodeEnum resultCodeEnum){
     ...
     * @param message 提示信息
     */
    public static <T> CommonResult<T> success (T data, ResultCodeEnum resultCodeEnum){
        return new CommonResult<T>(resultCodeEnum.getCode(), resultCodeEnum.getMessage(), data);
    }
